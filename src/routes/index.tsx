...
function AuthLanding() {
  const { t } = useI18n();
  const { session, loading, signInAsDemo } = useAuth();
        ...
        <div className="flex flex-1 flex-col px-5 py-6">
          ...
          <div className="mt-auto space-y-2.5 pt-6">
            <button
              ...
              className="tap flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-warm py-4 text-base font-bold text-primary-foreground shadow-card"
            >
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link
                to="/login"
                className="tap flex items-center justify-center rounded-2xl border border-primary/30 bg-card py-3 text-sm font-bold text-primary shadow-soft"
              >
                {t("login")}
              </Link>
              <Link
