...
function RootErrorView({ error, reset }: ErrorComponentProps) {
  console.error(error);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ShreniKart Artisans — Shreni Setu" },
      {
        name: "description",
        content:
          "AI-powered marketplace and smart cataloging assistant for Indian artisans.",
      },
